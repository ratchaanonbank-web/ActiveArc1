var color1 = document.getElementById("color1-T3");
var color2 = document.getElementById("color2-T3");
var color3 = document.getElementById("color3-T3");
...
color3.addEventListener("click", function () {
    ...
    if (selectedColor == "color3-T3") {
        ...
        selectedColor = "color3-T3";
    }

});

var sizeS = document.getElementById("sizeS-T3");
var sizeM = document.getElementById("sizeM-T3");
var sizeL = document.getElementById("sizeL-T3");
var sizeXL = document.getElementById("sizeXL-T3");
var selectedSize = "";
