var color1 = document.getElementById("color1-T1");
var color2 = document.getElementById("color2-T1");
var color3 = document.getElementById("color3-T1");
...
color3.addEventListener("click", function () {
    ...
    if (selectedColor == "color3-T1") {
        ...
        selectedColor = "color3-T1";
    }

});

var sizeS = document.getElementById("sizeS-T1");
var sizeM = document.getElementById("sizeM-T1");
var sizeL = document.getElementById("sizeL-T1");
var sizeXL = document.getElementById("sizeXL-T1");
var selectedSize = "";
